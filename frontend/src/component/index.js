...
//         config
//       );
//       // Filter out soft-deleted meetings before setting the state
...
//   // Define the decodeToken function to decode the JWT token
...
//   const handleEdit = async (id, name, duration, location) => {
//     try {
//       // Redirect to meeting setting page with meeting ID and name in URL query parameters
//       window.location.href = `/meetingsetting?id=${id}&name=${encodeURIComponent(name)}&duration=${encodeURIComponent(duration)}&location=${encodeURIComponent(location)}`;
//     } catch (error) {
